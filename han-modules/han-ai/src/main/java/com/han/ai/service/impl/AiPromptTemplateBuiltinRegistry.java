...
final class AiPromptTemplateBuiltinRegistry {
    ...
    private static final String AIVIDEO_ACTION_BUDGET_RULES = """

            【AIVideo 动作预算与道具关联硬规则】
            ...
            8. 短内容、祝福、口播、单场景剧情不能默认压成 1 个镜头；除非用户明确要求“一镜到底”，否则至少拆为 3 个镜头或 3 个画面段落：建立主体/道具锚点、核心动作、台词/结尾状态。
            """;
    ...
    static List<Seed> all() {
        return List.of(
                ...
                new Seed("AI短剧剧本生成", "aivideo_script", """
                        ...
                        6. 分镜建议：每段适合拆成几个镜头，每个镜头只有合理动作预算；短祝福/口播/单场景也不得默认 1 镜到底，至少拆出起势、核心动作、台词/结尾状态。
                        约束：
                        ...
                        润色稿：
                        {{polishedText}}
                        """ + AIVIDEO_ACTION_BUDGET_RULES, "[\"projectName\",\"targetPlatform\",\"ratio\",\"polishedText\"]", "AI短剧剧本生成默认模板"),
                new Seed("AI短剧资产提取", "aivideo_asset", """
                        ...
                        剧本：
                        {{scriptText}}
                        """ + AIVIDEO_ACTION_BUDGET_RULES, "[\"projectName\",\"scriptText\"]", "AI短剧角色场景分镜提取默认模板"),
                ...
                new Seed("AI短剧分镜提取", "aivideo_storyboard", """
                        ...
                        剧本：
                        {{scriptText}}
                        """ + AIVIDEO_ACTION_BUDGET_RULES, "[\"projectName\",\"scriptText\"]", "AI短剧分镜提取默认模板"),
                ...
                new Seed("AI短剧分镜视频生成", "aivideo_video", """
                        ...
                        镜头信息：
                        {{shotText}}
                        """ + AIVIDEO_ACTION_BUDGET_RULES, "[\"shotText\"]", "AI短剧分镜视频生成执行模板"),
