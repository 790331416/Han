...
abstract class AivideoServiceSupport {
    ...
    protected String characterDesignInstruction(String value, String visualStyle) {
        ...
        if (type.contains("Q版") || "CHIBI_FULL_BODY".equals(type)) {
            return "角色造型类型=Q版萌系全身：这是给 Seedance 视频生成使用的单主体角色锚定图，必须是 2.5-3.5 头身、圆润轮廓、大眼、短腿、稳定萌化比例、完整全身自然站姿；必须完整露出头部/脸、躯干、双手/手指或前爪、双脚/后爪、猫耳、猫尾或其他标志物，边缘不得裁切；服装、发型、眼睛颜色、猫耳猫尾、鞋袜和 2-3 个稳定识别特征必须清楚。背景只允许纯白/浅灰/极简棚拍。禁止头像、大头贴、半身像、贴纸、表情包、四视图、三视图、多视图、分栏设定表、多角度拼图、同款分身、真人写实、复杂剧情动作、强表情、文字、水印或 logo。";
        }
