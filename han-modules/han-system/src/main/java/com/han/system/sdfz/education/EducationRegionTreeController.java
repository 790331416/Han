...
public class EducationRegionTreeController {
    ...
    @GetMapping("/tree")
    @PreAuthorize(EducationPermissions.HAS_REGION_MANAGE + " or " + EducationPermissions.HAS_SCOPE_MANAGE)
    ...
    @RepeatSubmit
    @PostMapping
    @PreAuthorize(EducationPermissions.HAS_REGION_MANAGE)
