<template>
  <div class="operation-page">
    <section class="page-header"><div><h2>教室管理</h2><p>按学校维护建筑、楼层和场所；设备只挂接到最末级场所。</p></div><div><el-button v-perm="'education:room:add'" :disabled="!schoolId" @click="openBatch">批量创建楼层</el-button><el-button v-perm="'education:room:add'" type="primary" :icon="Plus" :disabled="!schoolId" @click="openAdd()">新增建筑</el-button></div></section>
