...
SET content = replace(
        ...
        replace(content,
            ...
            '对白、旁白/画外音、心声/心理活动必须三轨分清：角色直接说出口的话标注为“角色名说：“台词内容””；可发声但角色不张嘴的旁白/画外音标注为“旁白：内容”或“角色名（画外音）：内容”；心声/心理活动默认不朗读，写成眼神、动作、环境空镜或画面隐喻；低声报数、低声说、耳语、小声说、念出、读出都属于说出口的对白，禁止写成旁白、画外音或心声。'),
            ...
            '音画双轨',
            '音画三轨'),
            '心声/心理活动默认不朗读，写成眼神、动作、环境空镜或画面隐喻。',
            '心声/心理活动默认不朗读，写成眼神、动作、环境空镜或画面隐喻；低声报数、低声说、耳语、小声说、念出、读出都属于说出口的对白，禁止写成旁白、画外音或心声。'),
