            ...
            replace(
                replace(
                    replace(
                        ...
                        'promptText 必须写成：单一角色、纯白极简背景、四方向全身转面表，顺序固定为正面、左侧面、右侧面、背面；每个方向完整露出头部、躯干、四肢/爪子/脚、尾巴或标志性部位。',
                        'promptText 必须写成：单一主体、纯白/浅灰极简背景、3/4 正面或轻微侧正面自然站姿、全身完整可见、主体占画面高度 60%-75%。'
                    ),
                    'characters.promptText 必须可直接用于角色图生成，写成单一角色、纯白极简背景、四方向全身转面表，方向顺序固定为正面、左侧面、右侧面、背面；每个方向完整露出头部、躯干、四肢/爪子/脚、尾巴或标志性部位。',
                    'characters.promptText 必须可直接用于 Seedance 视频角色锚定图生成，写成单一主体、纯白/浅灰极简背景、3/4 正面或轻微侧正面自然站姿、全身完整可见、主体占画面高度 60%-75%。'
                ),
