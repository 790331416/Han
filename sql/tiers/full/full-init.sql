...
-- AI 短剧（aivideo）
--
-- 本区段随 aivideo-dev 分支于 2026-08-13 并入，只出现在 full 档。
-- 依赖前面已建好的 sys_dict_type / sys_dict_data / sys_menu / ai_prompt_template，
-- 反向无依赖，因此整体追加在文件末尾。
--
-- 字典条目显式写 tenant_id = 1：aivideo-dev 原文是不带 tenant_id 的裸 INSERT，
-- 落库为 NULL 会被列表接口的租户过滤挡掉，本仓库已因同类写法出现过
-- 「参数设置与字典管理整页为空」，并入时一并改齐。
-- =============================================

-- AI 短剧扩展字典类型
INSERT INTO sys_dict_type (id, tenant_id, dict_name, dict_type, status, remark) VALUES
(19, 1, 'AIVideo 项目阶段', 'aivideo_project_stage', 0, 'AI短剧项目阶段列表'),
(20, 1, 'AIVideo 项目状态', 'aivideo_project_status', 0, 'AI短剧项目状态列表'),
(21, 1, 'AIVideo 任务状态', 'aivideo_task_status', 0, 'AI短剧任务状态列表'),
(22, 1, 'AIVideo 画幅', 'aivideo_ratio', 0, 'AI短剧项目画幅列表'),
(23, 1, 'AIVideo 清晰度', 'aivideo_resolution', 0, 'AI短剧项目清晰度列表'),
(24, 1, 'AIVideo 视觉风格', 'aivideo_visual_style', 0, 'AI短剧视觉风格列表'),
(25, 1, 'AIVideo 生成策略', 'aivideo_generation_strategy', 0, 'AI短剧视频生成策略列表'),
(26, 1, 'AIVideo 声音模式', 'aivideo_audio_mode', 0, 'AI短剧声音模式列表'),
(27, 1, 'AIVideo 字幕模式', 'aivideo_subtitle_mode', 0, 'AI短剧字幕模式列表'),
(28, 1, 'AIVideo 参考素材策略', 'aivideo_reference_strategy', 0, 'AI短剧参考素材策略列表'),
(29, 1, 'AIVideo 动作强度', 'aivideo_action_intensity', 0, 'AI短剧动作强度列表'),
(30, 1, 'AIVideo 连续性强度', 'aivideo_continuity_level', 0, 'AI短剧连续性强度列表'),
(31, 1, 'AIVideo 多角色策略', 'aivideo_multi_role_strategy', 0, 'AI短剧多角色策略列表'),
(32, 1, 'AIVideo 角色造型类型', 'aivideo_character_design_type', 0, 'AI短剧角色造型类型列表'),
(33, 1, 'AIVideo 素材访问策略', 'aivideo_media_access_policy', 0, 'AI短剧素材访问策略列表');
...
(64, 1, 'ai_prompt_category', 'AIVideo 文本润色', 'aivideo_text', 40, '', 'primary', 0, 0),
(65, 1, 'ai_prompt_category', 'AIVideo 剧本生成', 'aivideo_script', 50, '', 'primary', 0, 0),
(66, 1, 'ai_prompt_category', 'AIVideo 资产提取', 'aivideo_asset', 60, '', 'success', 0, 0),
(67, 1, 'ai_prompt_category', 'AIVideo 分镜提取', 'aivideo_storyboard', 70, '', 'warning', 0, 0),
(68, 1, 'ai_prompt_category', 'AIVideo 图片生成', 'aivideo_image', 80, '', 'success', 0, 0),
(69, 1, 'ai_prompt_category', 'AIVideo 视频生成', 'aivideo_video', 90, '', 'warning', 0, 0),
(70, 1, 'ai_prompt_category', 'AIVideo 语音合成', 'aivideo_tts', 100, '', 'info', 0, 0),
(83, 1, 'aivideo_project_stage', '草稿', 'DRAFT', 10, '', 'info', 0, 0),
(84, 1, 'aivideo_project_stage', '原文已保存', 'DOCUMENT_SAVED', 20, '', 'primary', 0, 0),
(85, 1, 'aivideo_project_stage', '文档已确认', 'DOCUMENT_PARSED', 30, '', 'primary', 0, 0),
(86, 1, 'aivideo_project_stage', '润色已确认', 'POLISH_CONFIRMED', 40, '', 'success', 0, 0),
(87, 1, 'aivideo_project_stage', '剧本已确认', 'SCRIPT_CONFIRMED', 50, '', 'success', 0, 0),
(88, 1, 'aivideo_project_stage', '资产已确认', 'ASSET_CONFIRMED', 60, '', 'success', 0, 0),
(89, 1, 'aivideo_project_stage', '视频生成中', 'VIDEO_GENERATING', 70, '', 'warning', 0, 0),
(90, 1, 'aivideo_project_stage', '视频已确认', 'VIDEO_CONFIRMED', 80, '', 'success', 0, 0),
(91, 1, 'aivideo_project_status', '草稿', 'DRAFT', 10, '', 'info', 0, 0),
(92, 1, 'aivideo_project_status', '进行中', 'RUNNING', 20, '', 'warning', 0, 0),
(93, 1, 'aivideo_project_status', '暂停', 'PAUSED', 30, '', 'info', 0, 0),
(94, 1, 'aivideo_project_status', '已完成', 'FINISHED', 40, '', 'success', 0, 0),
(95, 1, 'aivideo_project_status', '已归档', 'ARCHIVED', 50, '', 'danger', 0, 0),
(96, 1, 'aivideo_task_status', '待执行', 'PENDING', 10, '', 'info', 0, 0),
(97, 1, 'aivideo_task_status', '执行中', 'RUNNING', 20, '', 'warning', 0, 0),
(98, 1, 'aivideo_task_status', '成功', 'SUCCESS', 30, '', 'success', 0, 0),
(99, 1, 'aivideo_task_status', '失败', 'FAILED', 40, '', 'danger', 0, 0),
(100, 1, 'aivideo_task_status', '已取消', 'CANCELED', 50, '', 'info', 0, 0),
(101, 1, 'aivideo_ratio', '9:16', '9:16', 10, '', 'primary', 1, 0),
(102, 1, 'aivideo_ratio', '16:9', '16:9', 20, '', 'success', 0, 0),
(103, 1, 'aivideo_ratio', '1:1', '1:1', 30, '', 'info', 0, 0),
(104, 1, 'aivideo_ratio', '4:3', '4:3', 40, '', 'warning', 0, 0),
(105, 1, 'aivideo_resolution', '720p', '720p', 10, '', 'primary', 1, 0),
(106, 1, 'aivideo_resolution', '1080p', '1080p', 20, '', 'success', 0, 0),
(107, 1, 'aivideo_resolution', '2K', '2K', 30, '', 'warning', 0, 0),
(108, 1, 'aivideo_visual_style', '写实电影感', '写实电影感', 10, '', 'primary', 0, 0),
(109, 1, 'aivideo_visual_style', '3D 国漫 CG', '3D 国漫 CG', 20, '', 'success', 0, 0),
(110, 1, 'aivideo_visual_style', '2D 日漫', '2D 日漫', 30, '', 'warning', 0, 0),
(111, 1, 'aivideo_visual_style', '复古胶片', '复古胶片', 40, '', 'info', 0, 0),
(112, 1, 'aivideo_visual_style', '赛博朋克', '赛博朋克', 50, '', 'danger', 0, 0),
(113, 1, 'aivideo_visual_style', '童话绘本', '童话绘本', 60, '', 'success', 0, 0),
(114, 1, 'aivideo_visual_style', '国风水墨', '国风水墨', 70, '', 'primary', 0, 0),
(115, 1, 'aivideo_generation_strategy', '自动', 'AUTO', 10, '', 'primary', 1, 0),
(116, 1, 'aivideo_generation_strategy', '视频延长', 'VIDEO_EXTEND', 20, '', 'warning', 0, 0),
(117, 1, 'aivideo_generation_strategy', '分段拼接', 'SEGMENT_STITCH', 30, '', 'success', 0, 0),
(118, 1, 'aivideo_generation_strategy', '轨道补齐', 'TRACK_FILL', 40, '', 'info', 0, 0),
(119, 1, 'aivideo_audio_mode', '静音', 'SILENT', 10, '', 'info', 0, 0),
(120, 1, 'aivideo_audio_mode', '原生有声', 'NATIVE_AUDIO', 20, '', 'success', 0, 0),
(121, 1, 'aivideo_audio_mode', '参考音频有声', 'REFERENCE_AUDIO', 30, '', 'warning', 0, 0),
(122, 1, 'aivideo_audio_mode', '后期 TTS', 'POST_TTS', 40, '', 'primary', 0, 0),
(123, 1, 'aivideo_subtitle_mode', '无字幕', 'NONE', 10, '', 'info', 0, 0),
(124, 1, 'aivideo_subtitle_mode', '底部字幕', 'BOTTOM', 20, '', 'primary', 0, 0),
(125, 1, 'aivideo_subtitle_mode', '气泡台词', 'BUBBLE', 30, '', 'success', 0, 0),
(126, 1, 'aivideo_subtitle_mode', '标题文字', 'TITLE', 40, '', 'warning', 0, 0),
(127, 1, 'aivideo_reference_strategy', '角色锚定', 'CHARACTER_ANCHOR', 10, '', 'primary', 0, 0),
(128, 1, 'aivideo_reference_strategy', '场景定调', 'SCENE_TONE', 20, '', 'success', 0, 0),
(129, 1, 'aivideo_reference_strategy', '运镜参考', 'CAMERA_REFERENCE', 30, '', 'warning', 0, 0),
(130, 1, 'aivideo_reference_strategy', '动作参考', 'ACTION_REFERENCE', 40, '', 'info', 0, 0),
(131, 1, 'aivideo_reference_strategy', '音频参考', 'AUDIO_REFERENCE', 50, '', 'warning', 0, 0),
(132, 1, 'aivideo_reference_strategy', '角色 + 场景', 'CHARACTER_SCENE', 60, '', 'primary', 1, 0),
(133, 1, 'aivideo_action_intensity', '低缓动作', 'LOW', 10, '', 'info', 0, 0),
(134, 1, 'aivideo_action_intensity', '普通动作', 'NORMAL', 20, '', 'primary', 1, 0),
(135, 1, 'aivideo_action_intensity', '强动作', 'STRONG', 30, '', 'warning', 0, 0),
(136, 1, 'aivideo_continuity_level', '普通', 'NORMAL', 10, '', 'info', 0, 0),
(137, 1, 'aivideo_continuity_level', '严格', 'STRICT', 20, '', 'primary', 1, 0),
(138, 1, 'aivideo_continuity_level', '极严格', 'ULTRA_STRICT', 30, '', 'warning', 0, 0),
(139, 1, 'aivideo_multi_role_strategy', '单角色优先', 'SINGLE_FIRST', 10, '', 'primary', 1, 0),
(140, 1, 'aivideo_multi_role_strategy', '多角色允许', 'MULTI_ALLOWED', 20, '', 'success', 0, 0),
(141, 1, 'aivideo_multi_role_strategy', '超过 4 人自动拆镜', 'SPLIT_OVER_FOUR', 30, '', 'warning', 0, 0),
(142, 1, 'aivideo_character_design_type', '自动', 'AUTO', 10, '', 'info', 1, 0),
(143, 1, 'aivideo_character_design_type', '写实自然比例', 'REALISTIC_NATURAL', 20, '', 'primary', 0, 0),
(144, 1, 'aivideo_character_design_type', '半写实卡通', 'SEMI_REAL_CARTOON', 30, '', 'success', 0, 0),
(145, 1, 'aivideo_character_design_type', '3D动漫/国漫CG', 'THREE_D_ANIME_CG', 40, '', 'warning', 0, 0),
(146, 1, 'aivideo_character_design_type', '2D动漫/日漫', 'TWO_D_ANIME', 50, '', 'warning', 0, 0),
(147, 1, 'aivideo_character_design_type', 'Q版萌系全身', 'CHIBI_FULL_BODY', 60, '', 'success', 0, 0),
(148, 1, 'aivideo_character_design_type', '低龄儿童绘本', 'CHILDREN_PICTURE_BOOK', 70, '', 'info', 0, 0),
(149, 1, 'aivideo_character_design_type', '动物本体萌化', 'ANIMAL_BODY_CUTE', 80, '', 'success', 0, 0),
(150, 1, 'aivideo_character_design_type', '拟人化角色', 'ANTHROPOMORPHIC', 90, '', 'primary', 0, 0),
(151, 1, 'aivideo_character_design_type', '怪物/夸张反派', 'MONSTER_VILLAIN', 100, '', 'danger', 0, 0),
(152, 1, 'aivideo_media_access_policy', '登录可见', 'PRIVATE', 10, '', 'info', 1, 0),
(153, 1, 'aivideo_media_access_policy', '公开可见', 'PUBLIC', 20, '', 'success', 0, 0);
...
UPDATE ai_prompt_template
SET content = content || $aivideo_action_budget_prop_rules$
...
$aivideo_action_budget_prop_rules$,
    update_by = 'system',
    update_time = CURRENT_TIMESTAMP
WHERE template_name IN ('AI短剧剧本生成', 'AI短剧资产提取', 'AI短剧分镜提取', 'AI短剧分镜视频生成')
  AND content NOT LIKE '%20260615动作预算与道具关联硬规则%';
