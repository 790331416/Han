...
3. promptText 要可直接用于角色图生成，必须写成四方向全身转面表：纯白极简背景，方向顺序固定为正面、左侧面、右侧面、背面；每个方向完整露出头部、躯干、四肢/爪子/脚、尾巴或标志性部位。
...
'AI短剧角色构建默认模板，强制角色图锚点使用四方向全身转面表', 1, '0'
...
5. characters.promptText 必须可直接用于角色图生成，写成单一角色、纯白极简背景、四方向全身转面表，方向顺序固定为正面、左侧面、右侧面、背面；每个方向完整露出头部、躯干、四肢/爪子/脚、尾巴或标志性部位。
6. characters.promptText 禁止写头部特写、面部特写、半身像、三视图或正侧背旧版版式；禁止用大头特写替代全身视图；动物保持自然四足站立，不拟人化。
...
'AI短剧角色图生成默认模板，强制四方向全身转面表和旧词屏蔽', 1, '0'
...
'AI短剧分镜视频生成默认模板，补充音画双轨、角色一致性和场景连续性强约束', 1, '0'
...
5. promptText 要可直接用于角色图生成，必须写成单一角色、纯白极简背景、四方向全身转面表，方向顺序固定为正面、左侧面、右侧面、背面；每个方向完整露出头部、躯干、四肢/爪子/脚、尾巴或标志性部位。
